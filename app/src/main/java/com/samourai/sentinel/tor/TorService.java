...
public class TorService extends Service {
    ...
    public void onCreate() {
        ...
        Notification notification = new Builder(this, SentinelApplication.TOR_CHANNEL_ID)
    ...
    private void updateNotification() {
        ...
        NotificationCompat.Builder notification = new NotificationCompat.Builder(this, SentinelApplication.TOR_CHANNEL_ID)
                .setOngoing(true)
